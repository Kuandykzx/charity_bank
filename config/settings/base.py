"""
Django settings for Charity bank project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'charity_bank.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Kazakhstan""", 'charity_bank@gmail.com'),
]
...
DATABASES = {
    # 'default': env.db('DATABASE_URL', default='postgres:///charity_bank'),
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': env('POSTGRES_DB_NAME', default='charity_bank'),
        'USER': env('POSTGRES_USER', default='charity_bank'),
        'PASSWORD': env('POSTGRES_PASSWORD', default='charity_bank'),
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
ACCOUNT_ADAPTER = 'charity_bank.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'charity_bank.users.adapters.SocialAccountAdapter'
